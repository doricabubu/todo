...
<html lang="en">
    <head>
        ...
        <script>
        	function registerUser() {
                ...
                if(!repeat_password) {
                    document.getElementById("error").innerHTML = "Repeat password empty";
                    return;
                }
                ...
                $.post("api/register", post_request_data, function(data) {
    ...
    <body class="d-flex flex-column h-100">
        <main role="main" class="flex-shrink-0 mt-5">
            <div class="container">
                <form name="registerform" class="form-signin">
                    <div class="text-center mb-4">
                        <h3 class="mb-3 font-weight-bold">Register</h3>
                    </div>
